...
${m_fvo.dataid } >>> : ${m_fvo.dataid }<br>
${formDataVO.datapw } >>> : ${formDataVO.datapw } : FormDataVO<br>
${formDataVO.dataname } >>> : ${formDataVO.dataname } : FormDataVO<br>
...
\${m_fvo.getDataid() } >>> : ${m_fvo.getDataid() }<br>
\${formDataVO.getDatapw() } >>> : ${formDataVO.getDatapw() } : FormDataVO<br>
\${formDataVO.getDataname() } >>> : ${formDataVO.getDataname() } : FormDataVO<br>
<p>
