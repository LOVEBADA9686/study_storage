...
public class FormDataController {
	...
	public String formdata_get_spring(FormDataVO fvo, Model m) {
		...
		System.out.println("formdata_gett_spring >>> : fvo :::: " + fvo);
		System.out.println("formdata_gett_spring >>> : fvo.getDatanum() :::: " + fvo.getDatanum());
		System.out.println("formdata_gett_spring >>> : fvo.getDataid() :::: " + fvo.getDataid());
		System.out.println("formdata_gett_spring >>> : fvo.getDatapw() :::: " + fvo.getDatapw());
		System.out.println("formdata_gett_spring >>> : fvo.getDataname() :::: " + fvo.getDataname());
	...
	public String formdata_post_modelattribute(@ModelAttribute("ma_fdvo") FormDataVO fdvo) {
		...
		*/
		System.out.println("FormDataController formdata_post_modelattribute >>> : fdvo :::: " + fdvo);
		System.out.println("FormDataController formdata_post_modelattribute >>> : fdvo.getDatanum() :::: " + fdvo.getDatanum());
		System.out.println("FormDataController formdata_post_modelattribute >>> : fdvo.getDataid() :::: " + fdvo.getDataid());
		System.out.println("FormDataController formdata_post_modelattribute >>> : fdvo.getDatapw() :::: " + fdvo.getDatapw());
		System.out.println("FormDataController formdata_post_modelattribute >>> : fdvo.getDataname() :::: " + fdvo.getDataname());

		return "mvc/formdata_post_spring_modeatrribute_return";
	}
